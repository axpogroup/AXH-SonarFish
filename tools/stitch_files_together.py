...
if __name__ == '__main__':
    ...
    files_local = "/Users/leivandresen/Documents/PROJECTS/SONAR_FISH/Field_test_Stroppel_20to24_10_22/weekend_backup/*.mp4"
    ...
    input_params = "'" + "".join([f"[{file_no}:0]" for file_no in np.arange(0, len(interest))]) +\
                   f"concat=n={len(interest)}:v=1:a=0[v]" + "'"
    command = "ffmpeg " + input_files + " -filter_complex " + input_params +\
